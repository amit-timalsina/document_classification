...
from ocr.providers.closed_source.google_vision import GoogleVisionOCR
from ocr.providers.open_source.paddle import PaddleOCRProvider
from ocr.providers.open_source.tesseract import TesseractOCR
